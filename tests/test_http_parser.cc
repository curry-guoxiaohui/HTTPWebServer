...
void test_request(const char *str) {
    gxh::http::HttpRequestParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        gxh::http::HttpRequest::ptr req = parser.getData();
        std::cout << req->toString() << std::endl;
    }
}

void test_response(const char *str) {
    gxh::http::HttpResponseParser parser;
    std::string tmp = str;
    ...
    if (parser.hasError()) {
        ...
        gxh::http::HttpResponse::ptr rsp = parser.getData();
