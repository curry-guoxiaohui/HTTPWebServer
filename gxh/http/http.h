 ...
 * @date 2021-09-24
 */
#ifndef __GXH_HTTP_HTTP_H__
#define __GXH_HTTP_HTTP_H__
...
public:
    ...
    void setCookie(const std::string& key, const std::string& val,
     ...
     void setFileResponse(bool v) { m_file_response = v; }

    bool getFileResponse() const { return m_file_response; }

    ByteArray::ptr getFileBa() { return m_file_ba; }

    void setFileBa(ByteArray::ptr ba) { m_file_ba = ba; }
private:
    /// 响应状态
    HttpStatus m_status;
    /// 版本
    ...
    std::vector<std::string> m_cookies;
     /// 是否为文件响应
    bool m_file_response;
    /// 文件资源
    ByteArray::ptr m_file_ba;
};
