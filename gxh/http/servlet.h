 ...
 * @date 2019-06-08
 * @copyright Copyright (c) 2019年 gxh.yin All rights reserved (www.gxh.top)
 */
#ifndef __GXH_HTTP_SERVLET_H__
#define __GXH_HTTP_SERVLET_H__
...
public:
     ...
     * @return 是否处理成功
     */
    virtual int32_t handle(gxh::http::HttpRequest::ptr request
                   , gxh::http::HttpResponse::ptr response
                   , gxh::http::HttpSession::ptr session) = 0;
...
public:
    ...
    /// 函数回调类型定义
    typedef std::function<int32_t (gxh::http::HttpRequest::ptr request
                   , gxh::http::HttpResponse::ptr response
                   , gxh::http::HttpSession::ptr session)> callback;
    ...
    virtual int32_t handle(gxh::http::HttpRequest::ptr request
                   , gxh::http::HttpResponse::ptr response
                   , gxh::http::HttpSession::ptr session) override;
private:
    /// 回调函数
    callback m_cb;
};
