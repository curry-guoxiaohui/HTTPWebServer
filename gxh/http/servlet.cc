...
int32_t FunctionServlet::handle(gxh::http::HttpRequest::ptr request
...
ServletDispatch::ServletDispatch()
    ...
    m_default.reset(new NotFoundServlet("gxh/1.0"));
}

int32_t ServletDispatch::handle(gxh::http::HttpRequest::ptr request
               , gxh::http::HttpResponse::ptr response
               , gxh::http::HttpSession::ptr session) {
...
int32_t NotFoundServlet::handle(gxh::http::HttpRequest::ptr request
                   , gxh::http::HttpResponse::ptr response
                   , gxh::http::HttpSession::ptr session) {
    response->setStatus(gxh::http::HttpStatus::NOT_FOUND);
    response->setHeader("Server", "gxh/1.0.0");
