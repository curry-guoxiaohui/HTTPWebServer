 ...
 * @author gxh
 */
#ifndef __GXH_CONFIG_H__
#define __GXH_CONFIG_H__
...
public:
    ...
    std::string toString() override {
        try {
            ...
            GXH_LOG_ERROR(GXH_LOG_ROOT()) << "ConfigVar::toString exception "
    ...
    bool fromString(const std::string &val) override {
        try {
            ...
            GXH_LOG_ERROR(GXH_LOG_ROOT()) << "ConfigVar::fromString exception "
...
public:
    ...
    static typename ConfigVar<T>::ptr Lookup(const std::string &name,
        ...
        if (it != GetDatas().end()) {
            ...
            if (tmp) {
                GXH_LOG_INFO(GXH_LOG_ROOT()) << "Lookup name=" << name << " exists";
                return tmp;
            } else {
                GXH_LOG_ERROR(GXH_LOG_ROOT()) << "Lookup name=" << name << " exists but type not "
        ...
        if (name.find_first_not_of("abcdefghikjlmnopqrstuvwxyz._012345678") != std::string::npos) {
            GXH_LOG_ERROR(GXH_LOG_ROOT()) << "Lookup name invalid " << name;
