 ...
 * @author gxh
 */
#ifndef __GXH_TCP_SERVER_H__
#define __GXH_TCP_SERVER_H__
...
public:
     ...
     */
    TcpServer(gxh::IOManager* worker = gxh::IOManager::GetThis()
              ,gxh::IOManager* io_woker = gxh::IOManager::GetThis()
     ...
     * @return 返回是否绑定成功
     */
    virtual bool bind(gxh::Address::ptr addr);
